...
employees = sorted(
    [emp for wdm in workshop_decision_makers for emp in wdm.employees],
    key=lambda x: x.hire_date,
)
services = sorted(
    [service for wdm in workshop_decision_makers for service in wdm.repairs],
    key=lambda x: x.start_date,
)
vehicles = sorted(
    [vehicle for wdm in workshop_decision_makers for vehicle in wdm.vehicles],
