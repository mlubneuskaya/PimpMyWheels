...
class Service(Base):
    ...
    employee = relationship("Employee", foreign_keys=[employee_id], back_populates="repairs")
    transaction = relationship("Transaction", foreign_keys=[transaction_id], back_populates="repairs")
    vehicle = relationship("Vehicle", foreign_keys=[vehicle_id], back_populates="repair")
