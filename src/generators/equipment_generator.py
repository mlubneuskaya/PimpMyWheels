...
name = [
    ...
    "Zestaw nasadek",
    "Zestaw imbusów",
    "Narzędzie do geometrii kół",
    "Ładowarka akumulatorów",
    "Miernik grubości lakieru",
    "Tester diagnostyczny",
    "Narzędzie do ustawiania świateł",
    "Prasa hydrauliczna",
    "Stetoskop samochodowy",
    "Tester ciśnienia",
    "Waga do kół",
    "Zestaw do odsysania oleju",
    "Zestaw do pomiaru ciśnienia",
    "Zestaw do regeneracji reflektorów",
]
type = [
    "Część",
    "Część",
...
equipment = {"nazwa": name, "typ": type, "cena": prices}
